> 最新主方向（2026-09-13）：用户确认问题2、问题3均采用方向3。问题3 `rolling_scenario` 已有334天审计结果和[结果包](../deliverables/q3/README.md)；问题2场景/CVaR方向尚未完成同等级实跑，现有 `combined` 结果继续作为基线证据，不能改名冒充方向3。决策见 [D-019](../memory/decisions/D-019-q2-q3-direction3-main.md)。

> 当前口径更新（2026-09-11）：先读 [已确认口径](confirmed-contract.md)。问题3逐次调整账本已明确；问题4实时波动不代表未来价格必然未知，价格预测不是已确定主线。下文为原候选路线，未批准项不自动成为硬约束。

> Task 4/Task 5 的当前路线确认见 [Task 4 与 Task 5 建模路线确认](task4-task5-decision.md)。
